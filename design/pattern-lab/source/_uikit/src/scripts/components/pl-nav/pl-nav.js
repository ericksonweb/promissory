          ...
          {patternGroups.map((item, i) => {
            ...
            return (
              <NavItem>
                ...
                <div className={`o-collapse menu__submenu ${item.patternGroupLC}`}>
                  <button className={`btn o-collapse__toggler menu__toggler ${item.patternGroupLC}__toggler`} aria-expanded={`false`} aria-controls={`${item.patternGroupLC}__collapse`} data-bs-toggle={`collapse`} data-bs-target={`#${item.patternGroupLC}__collapse`}><span className={`icon fa-fw fas fa-blank`}></span></button>
                  <div className={`o-collapse__content collapse menu__content ${item.patternGroupLC}__content`} id={`${item.patternGroupLC}__collapse`}>
